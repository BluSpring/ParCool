...
public class ClingToCliff extends Action {
	...
	public boolean canStart(Player player, Parkourability parkourability, ByteBuffer startInfo) {
		boolean value = (player.getDeltaMovement().y() < 0.2
				...
				&& (((KeyBindingAccessor) KeyBindings.getKeyGrabWall()).fabric_getBoundKey().equals(((KeyBindingAccessor) KeyBindings.getKeySneak()).fabric_getBoundKey()) || !player.isShiftKeyDown())
		);
	...
	public void onStartInLocalClient(Player player, Parkourability parkourability, ByteBuffer startData) {
		...
		armSwingAmount = 0;
		if (!((KeyBindingAccessor) KeyBindings.getKeyGrabWall()).fabric_getBoundKey().equals(((KeyBindingAccessor) KeyBindings.getKeySneak()).fabric_getBoundKey())) {
